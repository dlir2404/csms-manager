...
export default function ProductTab() {
    ...
    return (
        <>
            <Button className='mb-4' type="primary" onClick={() => setCreateModal(true)}>Add Product</Button>
            <div>
                {/* filter */}
            </div>
            <Table
            ...
            <DeleteProductModal isOpen={deleteModal} setIsOpen={setDeleteModal} product={choosenProduct} />
        </>
    )
}
