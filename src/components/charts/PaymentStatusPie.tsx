...
import { IPaymentStatusOverview } from '@/shared/types/payment'

const PaymentStatusPie = ({ statuses }: { statuses: IPaymentStatusOverview[] | undefined }) => {
  if (!statuses) {
    return <BaseLoading />
  }
  ...
  return (
    <div className="w-full h-[500px] bg-white rounded-lg shadow-sm">
      <div className="flex p-4 justify-between items-center">
        <div className="font-semibold text-lg">Payments status</div>
      </div>
