...
import { useGetPaymentMonthlyStatistic } from '@/services/payment.service'

const PaymentMonthlyChart = () => {
  const [day, setDay] = useState<dayjs.Dayjs>(dayjs())
  const { data, isLoading } = useGetPaymentMonthlyStatistic({
    year: day.year(),
  })
...
export default PaymentMonthlyChart
